...
## Exported label catalog

The validated YouTube scenario now has an import-ready compact catalog generated by:

```powershell
node .\tools\ems-measure.mjs export-labels .\snapshots\yt3-baseline.json .\snapshots\yt3-after-darkreader.json --source youtube-3ext-scenario --out .\docs\generated-youtube-benchmark-labels.json
node .\tools\ems-measure.mjs export-labels .\snapshots\yt3-baseline.json .\snapshots\yt3-after-bideomax.json --source youtube-3ext-scenario --out .\docs\generated-youtube-benchmark-labels.json
node .\tools\ems-measure.mjs export-labels .\snapshots\yt3-baseline.json .\snapshots\yt3-after-improveyoutube.json --source youtube-3ext-scenario --out .\docs\generated-youtube-benchmark-labels.json
```

That file can be imported directly into the popup benchmark controls.
